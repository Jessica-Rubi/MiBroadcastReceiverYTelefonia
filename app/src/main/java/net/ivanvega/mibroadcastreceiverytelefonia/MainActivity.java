...
import net.ivanvega.mibroadcastreceiverytelefonia.receivers.MiSMSBroadcast;
...
public class MainActivity extends AppCompatActivity {
    ...
    MiSMSBroadcast miSMSBroadcast = new MiSMSBroadcast();
...
//                broadcast.setAction(getString(R.string.action_broadcast));
                ...
                broadcast.putExtra("num",txtTel.getText());
                broadcast.putExtra("men",txtMessage.getText());
...
//        );
        ...
        IntentFilter filter1 = new IntentFilter(TelephonyManager.ACTION_PHONE_STATE_CHANGED);
        this.registerReceiver(miSMSBroadcast, filter1);
